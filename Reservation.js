  ...
  // }
    return (
        ...
        <View style ={{backgroundColor: "rgba(38,154,144,1)", marginLeft : 10, marginRight :10, marginTop : 10}}>
            ...
            <Text style = {styles.posttxt}>Welcome {userObj.first_name} {userObj.last_name}</Text>
            <View>
            <Text style = {styles.posttxt}>{reservation.header_text}</Text>
            <Text style = {styles.posttxt}>Description: {reservation.body_text}</Text>
            <Text style = {styles.posttxt}>Date of Expiration: {reservation.date_exp}</Text>
            <Text style = {styles.posttxt}>Delivery Location: {[reservation.street, reservation.city, reservation.state, reservation.country, reservation.zipcode]}</Text>
            <Text style = {styles.posttxt}>Producer: {reservation.produceremail}</Text>
