...
function ReviewPage({ navigation, route, props }){
  ...
  return (
    ...
    <View>
        ...
        <Text style = {styles.username}>Here are the reviews {userObj.first_name} {userObj.last_name}</Text>
        <Pressable style = {styles.altbtn} onPress = {() => navigation.navigate("PostInfo", route.params)}>
            <Text style = {{fontSize : 15, marginLeft : 100, marginTop :10, marginBottom : 30}}>
                I changed my mind
        ...
        /> 
        :<Text style = {{fontSize : 20, marginLeft : 70}}>No Reviews Found</Text>}
        {/* <RenderArray /> */}
        </View>
    </View>
    </ScrollView>
