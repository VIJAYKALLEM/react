...
function OrderHistory({ navigation, route, props }){
  ...
  return (
    ...
    <View>
        ...
        <Text style = {styles.username}>Here is your Order History {userObj.first_name} {userObj.last_name}</Text>
        <Pressable style = {styles.altbtn} onPress = {() => navigation.navigate("ListingPage")}>
            <Text style = {{fontSize : 15, marginLeft : 100, marginTop :10}}>
                I changed my mind
        ...
        /> 
        :<Text style = {{fontSize : 20, marginLeft : 60}}>No Completed Orders</Text>}
        </View>
    </View>
    </ScrollView>
  )
